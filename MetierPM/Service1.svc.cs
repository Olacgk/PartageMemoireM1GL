...
namespace MetierPM
{
    ...
    public class Service1 : IService1
    {
        ...
        /// <returns></returns>
        public List<Expert> GetExperts(string Name, string Prenom, string Specialite)
        {
            var liste = db.experts.ToList();
            if (!string.IsNullOrEmpty(Name))
            {
                liste = liste.Where(x=>x.Name.ToUpper().Contains(Name.ToUpper())).ToList();
            }
